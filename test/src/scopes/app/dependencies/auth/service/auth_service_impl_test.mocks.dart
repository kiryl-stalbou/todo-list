...
import 'package:todo_app_krainet/src/exceptions/impl/auth_exception.dart';
import 'package:todo_app_krainet/src/scopes/app/dependencies/auth/repository/auth_repository.dart';
...
final class MockAuthRepository implements AuthRepository {
  ...
  @override
  ValueStream<UserData?> get authStateChanges => _authStateChangesController.stream;
  ...
  @override
  Future<void> init() async => _authStateChangesController.add(_currentUser?.user);

  @override
  Future<void> signOut() async => _authStateChangesController.add(_currentUser = null);

  @override
  Future<void> signIn(String email, String password) async {
    final match = _users.firstWhereOrNull((user) => user.email == email && user.password == password);
  ...
  Future<void> signUp(String name, String email, String password) async {
    ...
    _currentUser = _UserPasswordWrapper(name: name, email: email, password: password);
